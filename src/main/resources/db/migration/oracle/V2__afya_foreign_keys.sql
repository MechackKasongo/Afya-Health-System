-- =============================================================================
-- AFYA — Foreign keys (Oracle) — V2
-- =============================================================================
-- Si V1 a ete "ignore" par un baseline Flyway (tables Hibernate deja la sans
-- execution du SQL V1), cette migration reapplique les memes contraintes (idempotent).
-- Contenu aligne sur V1__afya_foreign_keys.sql
-- =============================================================================
